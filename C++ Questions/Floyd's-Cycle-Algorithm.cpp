...
void insertAtTail(node *&head, int val)
{
    ...
    while (temp->next != NULL) // here we traverse through second last node because temp pointing to second last node and temp -> next will be NULL which will terminate loop there itself.
    {
        temp = temp->next;
    }
